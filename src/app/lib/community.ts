...
export const communityPosts: CommunityPost[] = [
  {
    ...
    content:
      "제가 실제로 쓰고 있는 단어 암기 루틴과 복습 흐름을 정리해봤어요. 짧게 자주 보고, 예문으로 다시 확인하는 방식이 특히 효과적이었습니다.",
    category: "학습팁",
    likes: 247,
    comments: 32,
    views: 1240,
  ...
  },
  {
    ...
    content:
      "시험 준비 중이라면 자주 나오는 단어부터 묶어서 보는 방법을 추천해요. 빈출 표현을 함께 익히면 기억이 더 오래갑니다.",
    category: "시험대비",
    likes: 189,
    comments: 24,
    views: 892,
  ...
  },
  {
    ...
    content:
      "접두사와 접미사만 알아도 낯선 단어의 의미를 유추하기 쉬워집니다. 단어를 분해해서 보면 암기 부담이 훨씬 줄어들어요.",
    category: "학습팁",
    likes: 156,
    comments: 18,
    views: 654,
  ...
  },
  {
    ...
    content:
      "단어를 짧고 자주 보는 습관이 생각보다 도움이 많이 됐어요. 처음엔 부담 없이 작은 양부터 시작하는 게 좋았습니다.",
    category: "후기",
    likes: 92,
    comments: 15,
    views: 421,
  ...
  },
  {
    ...
    content:
      "짧고 자주 쓰는 표현들을 정리해두면 회화 감각을 익히는 데 도움이 됩니다. 한 번에 많이보다 반복 노출이 중요해요.",
    category: "표현",
    likes: 312,
    comments: 41,
    views: 1567,
