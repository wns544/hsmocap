...
function buildAchievements(summary: Omit<StudyProgressSummary, "achievements">): StudyAchievement[] {
  return [
    { name: "첫걸음", description: "첫 단어를 맞히면 달성", icon: "🌱", earned: summary.uniqueStudiedWords >= 1 },
    { name: "연습왕", description: "10개 단어를 학습하면 달성", icon: "📘", earned: summary.uniqueStudiedWords >= 10 },
    { name: "꾸준함", description: "학습 세션 7회를 완료하면 달성", icon: "🔥", earned: summary.completedSessions >= 7 },
    { name: "퀴즈 마스터", description: "학습 세션 10회를 완료하면 달성", icon: "🏆", earned: summary.completedSessions >= 10 },
    { name: "집중력", description: "완벽한 학습 세션 5회를 달성", icon: "🎯", earned: summary.perfectSessions >= 5 },
    { name: "전문가", description: "숙련도 100인 단어 20개 달성", icon: "🧠", earned: summary.masteredWords >= 20 },
  ];
}
