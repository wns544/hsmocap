...
const quickStartSteps = [
  {
    ...
    description:
      "홈 탭에서는 학습 통계와 추천 학습 진입점을 빠르게 확인할 수 있습니다. 처음 방문한 경우에는 여기서 오늘 무엇을 시작하면 되는지 감을 잡는 용도로 보시면 됩니다.",
  },
  {
    title: "2. 학습 탭에서 레벨과 단어 확인",
    description:
      "학습 탭에서는 단어 목록을 살펴보고, 원하는 난이도 또는 학습 레벨에 맞는 단어를 고를 수 있습니다. 문장 학습, Shorts, 복습 기능도 이곳에서 바로 시작할 수 있습니다.",
  },
  {
    title: "3. 짧게 학습하고 바로 복습",
    description:
      "처음에는 많은 양보다 짧고 자주 학습하는 방식이 편합니다. 문장 퀴즈 또는 카드형 학습으로 가볍게 시작한 뒤, 복습 화면에서 다시 확인하는 흐름을 권장합니다.",
  },
];
...
const featureSections = [
  {
    ...
    details: [
      "학습 현황, 최근 학습 기록, 빠른 시작 버튼을 한눈에 볼 수 있습니다.",
      "무엇부터 해야 할지 모를 때 가장 먼저 확인하면 좋은 화면입니다.",
    ],
  },
  {
    icon: BookOpen,
    ...
    details: [
      "단어를 검색하거나 레벨별로 골라볼 수 있습니다.",
      "문장 학습, Shorts, 복습하기 버튼으로 원하는 학습 방식에 바로 진입할 수 있습니다.",
      "각 단어를 눌러 뜻과 관련 정보를 자세히 확인할 수 있습니다.",
    ],
  },
  {
    icon: Users,
    ...
    details: [
      "글을 읽으며 학습 아이디어를 얻을 수 있습니다.",
      "직접 글을 작성해 질문하거나 본인의 학습 경험을 공유할 수 있습니다.",
    ],
  },
  {
    icon: Star,
    ...
    details: [
      "자주 보고 싶은 단어를 따로 관리할 수 있습니다.",
      "반복 확인이 필요한 항목을 모아 복습 효율을 높일 수 있습니다.",
    ],
  },
  {
    icon: Settings,
    ...
    details: [
      "앱 사용 중 궁금한 점이 있으면 도움말에서 기본 흐름을 확인할 수 있습니다.",
      "불편한 점이나 제안은 피드백 보내기를 통해 전달할 수 있습니다.",
    ],
  },
  {
    ...
    details: [
      "홈에서 오늘의 학습 흐름을 확인합니다.",
      "학습 탭에서 단어를 몇 개 살펴본 뒤 문장 학습이나 Shorts를 시작합니다.",
      "학습 후에는 복습 화면이나 즐겨찾기에서 다시 확인하며 익숙해집니다.",
    ],
  },
];
    ...
    <div className="min-h-screen bg-stone-50">
      <div className="bg-white border-b border-stone-200 px-6 pt-12 pb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-stone-600">
          처음 방문한 사용자도 서비스의 구조를 쉽게 이해할 수 있도록, 주요 기능과 추천 사용 흐름을
          간결하게 정리했습니다.
        </p>
      </div>
